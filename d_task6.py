...
class RomanNumber:
    ...
    def __add__(self, other):
        if self.int_value is not None and other.int_value is not None:
            ...
            return RomanNumber('This if definitely not a roman literal')
    ...
    def __truediv__(self, other):
        if self.int_value is not None and other.int_value is not None:
            math_res = self.int_value / other.int_value
            if math_res == int(math_res):
                return RomanNumber(int(math_res))
            else:
                return RomanNumber('This if definitely not a roman literal')
        else:
            return RomanNumber('This if definitely not a roman literal')
